...
class MapEditor {
    ...
    testGame() {
        ...
        if (window.gameState) window.gameState.selectedCustomLevel = tempLevel;
        if (window.startGame) {
    ...
    loadLevelData(data, isPlayMode) {
        if (isPlayMode) {
            if (window.gameState) window.gameState.selectedCustomLevel = JSON.parse(JSON.stringify(data));
